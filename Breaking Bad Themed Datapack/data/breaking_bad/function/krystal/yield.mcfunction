...
summon item ~ ~0.2 ~ {PickupDelay:10s,Item:{id:"minecraft:prismarine_shard",count:1,components:{"custom_model_data":1802249,"minecraft:custom_name":'{"italic":false,"text":"Krystal Duší"}',"minecraft:custom_data":{BreakingBad:1b}}},Motion:[0.0,0.01,0.0]}