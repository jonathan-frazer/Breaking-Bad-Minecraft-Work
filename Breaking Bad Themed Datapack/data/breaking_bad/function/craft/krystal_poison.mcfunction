...
#Poison the Crystal
data merge entity @s {PickupDelay:10s,Item:{id:"minecraft:prismarine_shard",count:1,components:{"minecraft:custom_name":'{"italic":false,"text":"Krystal Duši"}',"minecraft:custom_data":{BreakingBad:1b,Poisoned:true},"minecraft:enchantment_glint_override":true}},Motion:[0.0,0.01,0.0]}